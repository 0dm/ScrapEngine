...
namespace scrap::editor {
    ...
    SceneHierarchyPanel::SceneHierarchyPanel(EditorApp& app) : EditorPanel("Hierarchy", app) {
    }
    ...
    void SceneHierarchyPanel::render() {
        ...
        if (ImGui::BeginPopup("CreateEntityPopup")) {
            if (ImGui::MenuItem("Empty Entity")) {
                app.createEmptyEntity();
            }
            if (ImGui::MenuItem("Box")) {
                app.createBoxEntity();
            }
            if (ImGui::MenuItem("Ball")) {
                app.createBallEntity();
            }
            ImGui::EndPopup();
        }
        ...
        for (int i = 0; i < static_cast<int>(entities.size()); ++i) {
            ...
            ImGui::TreeNodeEx(reinterpret_cast<void*>(static_cast<intptr_t>(i)), flags, "%s",
                              label);
        ...
        if (ImGui::BeginPopupContextWindow(nullptr, ImGuiPopupFlags_NoOpenOverItems |
            ...
            if (ImGui::MenuItem("Add Empty Entity")) {
                scrap::Entity newEntity("New Entity");
