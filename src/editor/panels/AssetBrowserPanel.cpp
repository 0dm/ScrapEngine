...
namespace scrap::editor {
    ...
    AssetBrowserPanel::AssetBrowserPanel(EditorApp& app) : EditorPanel("Asset Browser", app) {
    ...
    void AssetBrowserPanel::render() {
        ...
        // Directory tree (left)
        ImGui::BeginChild("DirTree", ImVec2(treeWidth, 0),
            ...
            if (ImGui::BeginTable("FileTable", 2,
                ...
                for (const auto& entry : files) {
                    ...
                    bool isImage = (ext == ".png" || ext == ".jpg" || ext == ".jpeg" ||
                                    ext == ".bmp" || ext == ".tga");
                    bool isShader = (ext == ".slang" || ext == ".spv" || ext == ".glsl" ||
                                     ext == ".vert" || ext == ".frag");
                    ...
                    if (ImGui::BeginDragDropSource(ImGuiDragDropFlags_SourceAllowNullID)) {
                        ...
                        ImGui::SetDragDropPayload("ASSET_FILE", pathStr.c_str(),
                                                  pathStr.size() + 1);
