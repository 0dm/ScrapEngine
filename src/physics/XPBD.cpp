...
namespace physics {
    ...
    void XPBDSolver::projectConstraints(std::vector<physics::Vertex>& vertices,
    ...
    void XPBDSolver::solveCloth(ClothData& cloth, const scrap::ClothSettings& settings,
                                float deltatime, const glm::vec3& externalAcceleration) {
