...
namespace scrap::editor {
    ...
    class Gizmo {
      public:
        ...
        virtual GizmoAxis hitTest(const Ray& ray, const glm::vec3& position,
                                  const glm::quat& rotation, float scale) const = 0;

        virtual void beginInteraction(GizmoAxis axis, const Ray& ray, const glm::vec3& entityPos,
                                      const glm::quat& rotation) = 0;
        virtual glm::vec3 updateInteraction(const Ray& ray, const glm::vec3& entityPos,
                                            const glm::quat& rotation) = 0;
