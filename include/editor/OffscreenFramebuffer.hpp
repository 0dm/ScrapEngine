...
#include <gpu/vulkan/ImageUtils.hpp>
...
namespace scrap::editor {
    ...
    class OffscreenFramebuffer {
      public:
        ...
        OffscreenFramebuffer(const scrap::PhysicalDevice& physicalDevice,
                             const scrap::LogicalDevice& logicalDevice, uint32_t initialWidth,
        ...
        SCRAP_NON_COPYABLE(OffscreenFramebuffer)
