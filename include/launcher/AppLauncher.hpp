...
namespace scrap::launcher {
    ...
    class AppLauncher {
      public:
        ...
        void initialize(uint32_t width, uint32_t height, const std::string& initialScenePath,
        ...
        void render(const std::function<bool(const LaunchRequest&)>& finalizeLaunch,
      ...
      private:
        ...
        bool finalizeLaunchRequest(const std::function<bool(const LaunchRequest&)>& finalizeLaunch,
