...
namespace physics {
    ...
    struct BendConstraint {
        ...
        BendConstraint(uint32_t sharedEdgeIndex, uint32_t sharedEdgeParticleA,
                       uint32_t sharedEdgeParticleB, uint32_t oppositeParticleA,
                       uint32_t oppositeParticleB, float restAngle,
            ...
            : sharedEdgeIndex(sharedEdgeIndex),
              ...
              triangleIndices{triangleA, triangleB}, restAngle(restAngle), compliance(compliance),
              lambda_(lambda) {
        }
