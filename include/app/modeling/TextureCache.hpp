    ...
    namespace modeling {
        ...
        class TextureCache {
          public:
            ...
            std::shared_ptr<Texture> getTexture(const std::string& path, TextureType type,
                                                bool sRGB);
          ...
          private:
            ...
            std::string makeCacheKey(const std::string& baseKey, TextureType type, bool sRGB) const;
